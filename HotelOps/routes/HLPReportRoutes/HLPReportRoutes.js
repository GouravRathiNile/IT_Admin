...
router.get("/DayWiseVarianceReport", controller.dayWiseVarianceReport);
router.get("/MonthWiseVarianceReport", controller.monthWiseVarianceReport);
...
router.get("/DayWiseVarianceReport/PDF", controller.dayWiseVarianceReportPdf);
router.get("/MonthWiseVarianceReport/PDF", controller.monthWiseVarianceReportPdf);
