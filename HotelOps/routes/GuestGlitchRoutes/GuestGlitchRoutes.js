...
router.post("/workflow/config", controller.saveWorkflowConfig);
router.get("/workflow/config", controller.getWorkflowConfig);
router.delete("/workflow/config", controller.deleteWorkflowConfig);
